...
namespace OpenAI
{
    ...
    public sealed class CreateChatCompletionRequest
    {
        ...
        public List<Functions> Functions { get; set; } //new
        public FunctionCall Function_call { get; set; } //new
    ...
    public struct ChatMessage
    {
        ...
        public Function_call? Function_call { get; set; } //new
    }

    public struct Function_call
    {
        public string Name { get; set; }
    ...
    public class Property //new
    {

        public Property Items { get; set; } //new
        public string Type { get; set; }
        public string Description { get; set; }
