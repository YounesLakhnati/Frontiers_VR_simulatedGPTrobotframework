...
public class PlutoGPT : AgentGPT
{
    private List<Functions> plutoFunctions;
    ...
    public override string prompt
    {
        ...
        {
            return
@"You are the red robot agent Pluto and are part of a simulation. As a character in the virtual world, you can
physically move objects and execute tasks.For example, you can pick up objects, but only pick up one
...
allowed to respond as anyone else but Pluto. There are two robots in the same room with you, Jupiter
and Neptun. The user may talk to you and your fellow robots simultaneously but you shall not consider
yourself as anything more than Pluto. Assume that Jupiter and Neptun are their own agents that process
...
and rely on system feedback.";
    ...
    public override void Start()
    {
        ...
        //plutoFunctions = new List<Functions>()
        //{
        //    new Functions(){
        //        Name = "douse",
        //        Description = "Douses an object with water.",
        ...
        //                    {
        //                        Type = "string",
        //                        Description = "The name of an object or location to douse in water.",
        ...
        //function_descriptions.AddRange(PlutoFunctions);
        Debug.Log("This is Pluto's prompt:" + prompt);
    ...
    ////Pluto specific override for validation
    ...
    //{
    //    Debug.Log("Pluto moves to:" + destination);
    ...
    //        log.AddEntry(Role.System, $"Pluto moved to {destination}.");
    //    }
    //    else
    //    {
